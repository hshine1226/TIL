...
[내가 쓴 블로그 글 참고](https://medium.com/@hshine1226/node-js%EC%99%80-django-%EC%A4%91%EC%97%90%EC%84%9C-%EB%AC%B4%EC%97%87%EC%9D%84-%EC%82%AC%EC%9A%A9%ED%95%B4%EC%95%BC%ED%95%A0%EA%B9%8C-ea8ae375aaaa)
...
SQL(Structured Query Language)은 **구조화된 쿼리언어**를 말한다. 따라서 이 SQL을 사용하게되면 RDBMS에서 데이터를 저장, 수정, 삭제 및 검색 할 수 있다.
